...
train_photo = cv2.imread('Images/1999.9999999999998_0.jpg')
...
query_photo = cv2.imread('Images/1999.9999999999998_500.0.jpg')
...
cv2.imwrite('res2.jpg', cv2.cvtColor(result, cv2.COLOR_BGR2RGB))